...
_G.packer_plugins = {
  ...
  ["hop.nvim"] = {
    ...
    loaded = true,
    path = "/home/matt/.local/share/nvim/site/pack/packer/start/hop.nvim",
  ...
  kommentary = {
    loaded = true,
    path = "/home/matt/.local/share/nvim/site/pack/packer/start/kommentary",
  ...
  ["nvim-colorizer.lua"] = {
    ...
    loaded = true,
    path = "/home/matt/.local/share/nvim/site/pack/packer/start/nvim-colorizer.lua",
  ...
  ["tmux.nvim"] = {
    config = { "\27LJ\2\nk\0\0\4\0\6\0\t6\0\0\0'\2\1\0B\0\2\0029\0\2\0005\2\4\0005\3\3\0=\3\5\2B\0\2\1K\0\1\0\15navigation\1\0\0\1\0\1\31enable_default_keybindings\2\nsetup\ttmux\frequire\0" },
    loaded = true,
    path = "/home/matt/.local/share/nvim/site/pack/packer/start/tmux.nvim",
  ...
  ["vim-elixir"] = {
    loaded = true,
    path = "/home/matt/.local/share/nvim/site/pack/packer/start/vim-elixir",
  ...
  ["vim-prisma"] = {
    loaded = true,
    path = "/home/matt/.local/share/nvim/site/pack/packer/start/vim-prisma",
    url = "https://github.com/prisma/vim-prisma"
  },
  ["vim-test"] = {
    config = { ' require("plugins.vimtest")' },
    loaded = true,
    path = "/home/matt/.local/share/nvim/site/pack/packer/start/vim-test",
    url = "https://github.com/vim-test/vim-test"
  },
  vimux = {
    loaded = true,
    path = "/home/matt/.local/share/nvim/site/pack/packer/start/vimux",
